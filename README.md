...
![手搓一个单门柜：画型材、装角码、装柜门、出清单（6 倍速）](docs/demo.gif)
...
放在一张图里，挪一根型材要把 358 根的接头都重算一遍，而谁也不会一次做一整套房子的柜子。
那里还有**六件单独的家具**——L 形橱柜、双开门衣柜、书桌、高书架、开放展示架、带脚轮的工具车
——挑的是结构上真正不同的六种，不是同一个盒子换尺寸。
