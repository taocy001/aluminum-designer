...
![一字型厨房含吊柜](examples/kitchen-straight-3600-wall.png)

上图是用这个工具搭的一套一字型厨房（含吊柜、隔层与灶下双抽）：3640 × 640 × 2220，
76 根型材、138 个角码、16 块板，下料总长 68.12 m。工程文件和物料清单在
[`examples/`](examples/) 里，可以直接导入打开。
